...
public enum FileServerErrorEnum implements ErrorCode {
    ...
    STORE_FIEL_DIRCTORY_NOT_EXIST(1018,"服务端不存在保存文件的文件夹"),
    STORE_FILE_ERROR(1019,"保存文件时出错"),
    FILE_EXIST_ON_SERVER(1020,"文件在服务器已存在"),
    FILE_NOT_EXIST_ON_DEFINE_DIRECTORY(1021,"文件未存在于服务器的指定文件夹里");
