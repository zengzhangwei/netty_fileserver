...
public class HttpDownloadTest {
   // private static String filename = "download";
    private static String filepath = "C:\\Users\\scream\\Desktop\\fileDst\\" ;  //下载好的文件的保存目录
    private static String requestFileURI = "http://"+ TestConfiguration.HOST_IP+":8080/fileDownload?id=" + 88 + "&filePath=" + "/";
    ...
    private void download() throws IOException {
        ...
        if (!response.isSuccessful()) {
            ...
            System.out.println("get the fileName: " + fileName);
